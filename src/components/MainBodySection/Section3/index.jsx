    ...
    <div className='section'>
      <div className='content'>
        <div className='main-container-2'>
          <div className='temp-box' style={{
              left : "5%", transform: "translate(0%, 40%)"}}>
            <p className="font-size-30"><br></br><br></br><br></br>다양한 배경으로 변환!</p>
            <p ><br></br>에펠탑, 경복궁, 콜로세움, 런던아이 등등 <br></br> 유명한 관광명소에 직접 가지 않아도
            text prompt를 통해 <br></br> 구체적으로 배경의 형태를 변경할 수 있습니다. </p>
          </div>
          <div className='temp-box' style={{
              left : "5%", transform: "translate(-10%, 50%)"}}>
        ...
        <div className='main-container-2'>
          <div className='temp-box' style={{
              left : "5%", transform: "translate(10%, 70%)"}}>
            <img src={IMG} className="section-img" />
          </div>
          <div className='temp-box' style={{
              left : "5%", transform: "translate(-10%, 70%)"}}>
